...
@Client.on_message(command(["playlist", "playlist@magician_music_bot"]) & other_filters)
...
@Client.on_message(command(["delmyplaylist", "delmyplaylist@Magician_music_bot"]) & other_filters)
...
@Client.on_message(command(["delchatplaylist", "delchatplaylist@Magician_music_Bot"]) & other_filters)
